...
const HomePage = () => {
  ...
  return (
    ...
    >
      <article className="flex flex-col w-full min-h-[100vh] md:min-h-[50vh] md:min-w-[50vw] backdrop-blur-6 sm:backdrop-blur-10 justify-center items-center rounded-lg overflow-hidden">
        <Transition
          show={onLoad}
